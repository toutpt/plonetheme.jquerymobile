jQuery(function(jq) {
  ...
  // the overlay itself
/* remove the overlay because we get ride of jquerytools in jquerymobile.
 * We need to rewrite this to support related items.
 * Can't wait to see a content picker widget which works on mobile and desktop
